...
const PostCardReactionBar = ({ userReactionType, onReact, onComment }) => {
    return (
        <div className="_feed_inner_timeline_reaction">
            <ReactionButton value={userReactionType || null} onSelect={onReact} />
...
export default PostCardReactionBar;
