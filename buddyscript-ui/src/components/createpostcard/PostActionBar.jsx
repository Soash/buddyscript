...
const PostActionBar = ({ onPhotoClick, onVideoClick, onEventClick, onArticleClick }) => {
    return (
        <>
            {/* --- DESKTOP VIEW --- */}
                ...
                <div className="_feed_inner_text_mobile">
                    <div className="_feed_inner_text_area_item">
                        ...
                        <div className="_feed_inner_text_area_bottom_video _feed_common">
                            <button type="button" className="_feed_inner_text_area_bottom_photo_link" onClick={onVideoClick}> 
                                <span className="_feed_inner_text_area_bottom_photo_iamge _mar_img">   
                        ...
                        <div className="_feed_inner_text_area_bottom_event _feed_common">
                            <button type="button" className="_feed_inner_text_area_bottom_photo_link" onClick={onEventClick}>  
                                <span className="_feed_inner_text_area_bottom_photo_iamge _mar_img">  
                                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="24" fill="none" viewBox="0 0 22 24">
                        ...
                        <div className="_feed_inner_text_area_bottom_article _feed_common">
                            <button type="button" className="_feed_inner_text_area_bottom_photo_link" onClick={onArticleClick}> 
                                <span className="_feed_inner_text_area_bottom_photo_iamge _mar_img"> 
                    ...
                    <div className="_feed_inner_text_area_btn">
                        {/* Notice I updated this to type="submit" so your form fires properly */}
