...
const Navbar = () => {
    ...
    // ⭐ NEW: Search toggle state for mobile
                ...
                <div className="container _custom_container">
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <ul className="navbar-nav mb-2 mb-lg-0 _header_nav_list ms-auto _mar_r8">
                            ...
                            <li className="nav-item _header_nav_item">
                                <Link className="nav-link _header_nav_link" aria-current="page" to="/connections">
                            ...
                            <li className="nav-item _header_nav_item">
                                ...
                                >
                                    ...
                                    <NotificationDropdown isOpen={isNotifyOpen} />
                                </span>
                            </li>
                            <li className="nav-item _header_nav_item">
                                <a className="nav-link _header_nav_link" aria-current="page" href="/coming-soon">
                        ...
                        <div className="_header_nav_profile">
                            ...
                            <div className="_header_nav_dropdown" onClick={() => setIsProfileOpen(!isProfileOpen)} style={{ cursor: 'pointer' }}>
                                <p className="_header_nav_para">{currentUser?.first_name} {currentUser?.last_name}</p>
                            ...
                            <div id="_prfoile_drop"
                                ...
                                <div className="_nav_profile_dropdown_info">
                                    ...
                                    <div className="_nav_profile_dropdown_info_txt">
                                        ...
                                        <Link to={`/profile/${currentUser?.id}`} className="_nav_drop_profile">
                                            View Profile
                                        </Link>
                                    </div>
                                </div>
                                ...
                                <ul className="_nav_dropdown_list">
                                    ...
                                    <li className="_nav_dropdown_list_item">
                                        <Link to="/support" className="_nav_dropdown_link">
                                            <div className="_nav_drop_info">
                                                <span>
                        ...
                        <div className="_header_mobile_menu">
                            <div className="row">
                                <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                    <div className="_header_mobile_menu_top_inner" style={{ position: 'relative' }}>
                                        ...
                                        <div className="_header_mobile_menu_right" style={{ flex: 1, justifyContent: 'flex-end' }}>
                                            <form
                                                className="_header_form_grp"
                                                onSubmit={handleSearchSubmit}
                                                style={{ width: '100%', display: 'flex', justifyContent: 'flex-end', position: 'static' }}
                                            >
                                                
                                                {/* ⭐ Added onClick handler to toggle the search dropdown */}
                                                <a 
                                                    href="#0" 
                                                    className="_header_mobile_search" 
                                                    onClick={(e) => { e.preventDefault(); setIsMobileSearchOpen(!isMobileSearchOpen); }}
                                                > 
                                                ...
                                                {/* ⭐ Styled the input to act as a sleek absolute dropdown! */}
                                                <input
                                                    ...
                                                    onChange={(e) => setSearchText(e.target.value)}
                                                    style={{
                                                        display: isMobileSearchOpen ? 'block' : 'none',
                                                        position: 'absolute',
                                                        top: '100%',
                                                        left: 0,
                                                        right: 0,
